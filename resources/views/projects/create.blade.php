            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                @empty($project)
                    <form action="{{ route('projects.store') }}" method="POST">
                        @csrf
                        <textarea name="email_content" id="email_content" rows="10" placeholder="メールのタイトルから本文までをすべて貼り付ける" required
                        ...
                        <div class="flex justify-center">
                            <button type="submit"
                                class="bg-yellow-300 hover:bg-yellow-200 text-gray-700 font-bold rounded-full px-4 py-1">登録</button>
                        </div>
                    </form>
                @endempty
